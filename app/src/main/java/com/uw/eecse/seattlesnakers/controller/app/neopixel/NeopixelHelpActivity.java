...
import com.uw.eecse.seattlesnakers.controller.app.CommonHelpActivity;
...
public class NeopixelHelpActivity extends CommonHelpActivity {
    ...
    // Constants
    private static final String AUTHORITY = "com.uw.eecse.seattlesnakers.controller.fileprovider";          // Same as the authority field on the manifest provider
